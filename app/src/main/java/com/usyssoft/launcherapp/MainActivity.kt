package com.usyssoft.launcherapp
...
class MainActivity() : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val mTopDrawerLayout : LinearLayout = findViewById(R.id.topDrawerLayout)
    ...
    private fun initializeHome() {
        ...
        if (shortcutManager != null) {
            ...
            for (info in shortcuts) {
                val shortcutLabel = info.shortLabel

                val shortcutIntent = info.intent
                // Burada kısayol bilgileri ile işlem yapabilirsiniz
            }
        }
